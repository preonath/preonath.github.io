...
<div class="slideshow-container">
  <!-- Slide 1 -->
  <div class="mySlides" style="background-image: url('../../files/img/research/NextSeq_Sequencing_load_1.jpg'); background-size: cover; background-position: center; height: 1500px;"></div>
  
  <!-- Slide 2 -->
  <div class="mySlides" style="background-image: url('../../files/img/research/NextSeq_Sequencing_load_2.jpg'); background-size: cover; background-position: center; height: 1500px;"></div>
  
  <!-- Slide 3 -->
  <div class="mySlides" style="background-image: url('../../files/img/research/NextSeq_Sequencing_load_3.jpg'); background-size: cover; background-position: center; height: 1500px;"></div>
</div>
