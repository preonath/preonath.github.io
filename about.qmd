...
<script>
  ...
  // Video sources list
  const videoList = [
    "../../files/img/front_page/video_1.mp4",
    "../../files/img/front_page/video_2.mp4",
    "../../files/img/front_page/video_3.mp4",
    "../../files/img/front_page/nib_research_1.mp4"
    "../../files/img/front_page/nib_research_2.mp4"
    "../../files/img/front_page/video_4.mp4",
    "../../files/img/front_page/video_5.mp4",
    "../../files/img/front_page/video_6.mp4",
  ];

  // Image sources list
  const imageList = [
    "../../files/img/front_page/HCA_1.jpeg",
    "../../files/img/front_page/HCA_2.jpeg",
    "../../files/img/front_page/HCA_4.jpeg",
    "../../files/img/front_page/ai_in_public_health_1.jpeg"
  ];
  ...
  function playNextVideo() {
    if (videoIndex < videoList.length) {
      ...
      videoSource.src = videoList[videoIndex];
      video.load();

      video.onloadedmetadata = () => {
        // Calculate playback rate to fit the video into 3 seconds
        const playbackSpeed = video.duration / 3;
        video.playbackRate = playbackSpeed; // Set playback rate
        video.play();

        // Force the next video after 3 seconds
        setTimeout(() => {
          videoIndex++;
          playNextVideo();
      ...
      // After all videos are played, start the image slideshow
      startSlideshow();
    }
  }
  ...
  function startSlideshow() {
    ...
    slideshow.style.display = 'block'; // Show the image container in the same frame
    showNextImage();
  }

  function showNextImage() {
    if (imageIndex < imageList.length) {
      slideshow.src = imageList[imageIndex];
      imageIndex++;

      // Show the next image after 3 seconds
      setTimeout(showNextImage, 3000); // Change image every 3 seconds
    } else {
      // After all images are displayed, restart the entire sequence
  ...
  function resetSequence() {
    // Hide the slideshow image before restarting the video
    slideshow.style.display = 'none';

    // Reset video and image indexes and start over
    videoIndex = 0;
    imageIndex = 0;

    // Reset the video element visibility
    video.style.display = 'block';
    
    // Reset the video and restart from the first video
    video.currentTime = 0;  // Set video time to 0
    video.play();  // Start the video again

    playNextVideo(); // Start playing videos again from the first
  }
