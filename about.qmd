...
I am a **Bioinformatician** at the [Child Health Research Foundation](https://chrfbd.org/) working to improve child health through research and advocacy by applying my expertise in biochemistry, molecular biology, genomics, single-cell genomics, and computer science to develop computational methods for understanding disease genomics and fostering collaborations.
...
<div class="static-video" style="position: relative; width: 800px; height: 300px;">
  <video id="fast-video" controls autoplay muted style="width: 100%; height: 100%; position: absolute; top: 0; left: 0;">
    <source id="video-source" src="../../files/img/front_page/video_1.mp4" type="video/mp4">
    Your browser does not support the video tag.
  </video>

  <img id="slideshow" src="../../files/img/front_page/HCA_1.jpeg" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); display: none; width: 400px; height: 300px;">
</div>

<!-- Title below the media -->
<p id="media-title" style="text-align: center; font-size: 18px; margin-top: 10px; font-weight: bold;"></p>
...
<script>
  ...
  // Video sources and titles
  const videoList = [
    { src: "../../files/img/front_page/video_1.mp4", title: "Genome Sequencing at NextSeq-2000" },
    { src: "../../files/img/front_page/video_2.mp4", title: "Genome Sequencing at NextSeq-2000" },
    { src: "../../files/img/front_page/video_3.mp4", title: "Genome Sequencing at NextSeq-2000" },
    { src: "../../files/img/front_page/Nanopore_Seq_Run_5.mp4", title: "Genome Sequencing at Oxford Nanopore Sequencer" },
    { src: "../../files/img/front_page/honeycomb.mp4", title: "Single-Cell Honeycomb Method" },
    { src: "../../files/img/front_page/nib_research_1.mp4", title: "Rota Vaccine Trial at Mice Model" },
    { src: "../../files/img/front_page/nib_research_2.mp4", title: "Rota Vaccine Trial at Mice Model" },
    { src: "../../files/img/front_page/video_4.mp4", title: "Genome Sequencing at iSeq-100" },
    { src: "../../files/img/front_page/video_5.mp4", title: "Genome Sequencing at iSeq-100" },
    { src: "../../files/img/front_page/video_6.mp4", title: "Nucleotide Extraction at Semi-Automated Magbead" }
  ];

  // Image sources and titles
  const imageList = [
    { src: "../../files/img/front_page/HCA_1.jpeg", title: "Poster-Presentation at Human Cell Atlas Workshop, Thailand to John Randell" },
    { src: "../../files/img/front_page/HCA_2.jpeg", title: "Poster-Presentation at Human Cell Atlas Workshop, Thailand to Professor Alex K. Shalek" },
    { src: "../../files/img/front_page/HCA_4.jpeg", title: "Poster-Presentation at Human Cell Atlas Workshop, Thailand to My Team Member" },
    { src: "../../files/img/front_page/ai_in_public_health_1.jpeg", title: "Teaching at AI in Public Health Workshop" },
    { src: "../../files/img/front_page/group_presentation.jpeg", title: "Group Presentation at Human Cell Atlas Workshop, Thailand" },
    { src: "../../files/img/front_page/bacterial_genomics_1.jpg", title: "Teaching at Bacterial Genomics & Antimicrobial Resistance Workshop" },
    { src: "../../files/img/front_page/cat_2.jpeg", title: "Poster-Presentation at CAT Conference, Africa" },
    { src: "../../files/img/front_page/cat_5.jpeg", title: "Poster-Presentation at CAT Conference, Africa" },
    { src: "../../files/img/front_page/ont_1.jpg", title: "Genome Sequencing at Oxford Nanopore Sequencer" },
    { src: "../../files/img/front_page/culture_1.jpeg", title: "Microbes in the Culture Plate" },
    { src: "../../files/img/front_page/Awarwed_from_Zafor_Iqbal.jpg", title: "Awarwed from Dr. Zafor Iqbal" },
  ];
  ...
  function playNextVideo() {
    if (videoIndex < videoList.length) {
      // Set the current video source and title
      videoSource.src = videoList[videoIndex].src;
      mediaTitle.innerText = videoList[videoIndex].title;
      video.load();
      video.play();

      video.onloadedmetadata = () => {
        // Calculate playback rate to fit the video into 3 seconds
        const playbackSpeed = video.duration / 3;
      ...
      // Start the image slideshow once videos are done
      startSlideshow();
    }
  }
  ...
  function startSlideshow() {
    ...
    slideshow.style.display = 'block'; // Show the image container
    showNextImage();
  }

  function showNextImage() {
    if (imageIndex < imageList.length) {
      // Set the current image source and title
      slideshow.src = imageList[imageIndex].src;
      mediaTitle.innerText = imageList[imageIndex].title;
      imageIndex++;

      // Show the next image after 3 seconds
      setTimeout(showNextImage, 3000);
    } else {
      // Restart the sequence after the slideshow finishes
      resetSequence();
    }
  }

  function resetSequence() {
    // Reset video and image indexes
    videoIndex = 0;
    imageIndex = 0;

    // Hide slideshow and show video
    slideshow.style.display = 'none';
    video.style.display = 'block';

    // Start the video sequence again
    playNextVideo();
  }
