...
I am a **Bioinformatician** at the [Child Health Research Foundation](https://chrfbd.org/) specializing in genomics and single-cell genomics. I also work to develop deep learning models using pediatric X-Ray samples to advance child health through computational analysis. By combining my expertise in biochemistry, molecular biology, and computer science, I aim to better understand disease genomics.
...
<script>
  ...
  const mediaList = [
    // --- Images ---
    { type: "image", src: "../../files/img/front_page/Microscopy.jpg", title: "HIVE " },
    { type: "image", src: "../../files/img/front_page/HIVE_1.jpg", title: "HIVE " },
    { type: "image", src: "../../files/img/front_page/HIVE_2.jpg", title: "HIVE Team Discussion" },
    { type: "image", src: "../../files/img/front_page/HCA_1.jpeg", title: "HCA Workshop with John Randell" },
    { type: "image", src: "../../files/img/front_page/HCA_2.jpeg", title: "HCA Workshop with Prof. Alex K. Shalek" },
    { type: "image", src: "../../files/img/front_page/HCA_4.jpeg", title: "HCA Workshop with My Team Member" },
    { type: "image", src: "../../files/img/front_page/ai_in_public_health_1.jpeg", title: "AI in Public Health Workshop" },
    { type: "image", src: "../../files/img/front_page/group_presentation.jpeg", title: "Group Presentation at HCA" },
    { type: "image", src: "../../files/img/front_page/bacterial_genomics_1.jpg", title: "Teaching Bacterial Genomics" },
    { type: "image", src: "../../files/img/front_page/cat_2.jpeg", title: "CAT Conference, Africa - 1" },
    { type: "image", src: "../../files/img/front_page/cat_5.jpeg", title: "CAT Conference, Africa - 2" },
    { type: "image", src: "../../files/img/front_page/ont_1.jpg", title: "Oxford Nanopore Sequencer in Action" },
    { type: "image", src: "../../files/img/front_page/culture_1.jpeg", title: "Microbes in Culture Plate" },
    { type: "image", src: "../../files/img/front_page/Awarwed_from_Zafor_Iqbal.jpg", title: "Awarded by Dr. Zafar Iqbal" },
    { type: "video", src: "../../files/img/front_page/HIVE_3.mp4", title: "HIVE Lab Work" },
    { type: "video", src: "../../files/img/front_page/Honeycomb_Vacuum_Pump.mp4", title: "Honeycomb Vacuum Pump" },
    { type: "video", src: "../../files/img/front_page/video_1.mp4", title: "Genome Sequencing at NextSeq-2000 (1)" },
    { type: "video", src: "../../files/img/front_page/video_2.mp4", title: "Genome Sequencing at NextSeq-2000 (2)" },
    { type: "video", src: "../../files/img/front_page/video_3.mp4", title: "Genome Sequencing at NextSeq-2000 (3)" },
    { type: "video", src: "../../files/img/front_page/Nanopore_Seq_Run_5.mp4", title: "Oxford Nanopore Sequencing" },
    { type: "video", src: "../../files/img/front_page/honeycomb.mp4", title: "Single-Cell Honeycomb Method" },
    { type: "video", src: "../../files/img/front_page/nib_research_1.mp4", title: "Rota Vaccine Trial - 1" },
    { type: "video", src: "../../files/img/front_page/nib_research_2.mp4", title: "Rota Vaccine Trial - 2" },
    { type: "video", src: "../../files/img/front_page/video_4.mp4", title: "Genome Sequencing at iSeq-100 (1)" },
    { type: "video", src: "../../files/img/front_page/video_5.mp4", title: "Genome Sequencing at iSeq-100 (2)" },
    { type: "video", src: "../../files/img/front_page/video_6.mp4", title: "Nucleotide Extraction on MagBead" }
  ];
  ...
  function playNextMedia() {
    if (mediaIndex >= mediaList.length) {
      mediaIndex = 0; // Restart loop
    }

    const current = mediaList[mediaIndex];
    mediaTitle.innerText = current.title;

    if (current.type === "image") {
      video.style.display = "none";
      slideshow.style.display = "block";
      slideshow.src = current.src;
