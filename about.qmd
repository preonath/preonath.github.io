...
<div class="static-video">
  <video controls autoplay muted style="margin-top: 10px; height: 300px; width: 800px;">
    <source src="../../files/img/research/Single_Cell_Genomics/video_3.mp4" type="video/mp4">
