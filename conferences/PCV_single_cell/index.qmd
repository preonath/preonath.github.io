---
title: "Impact of PCV‑10 vaccination on the immune cell population of pre‑term infants in rural Bangladesh."
description: "2025 Human Cell Atlas General Meeting, Singapore."
date: "2025-06-09"
image: "HCA_2025_11.jpeg"
format:
  html:
    includes:
      in_header: style.css
...
<div id="intro-section" style="position: relative; text-align: center; color: white;">
  ...
  <div class="slideshow-container">
    <div class="mySlides fade" style="background-image: linear-gradient(to bottom right, rgba(0, 128, 128, 0.3), rgba(0, 128, 128, 0.3)), url('../../files/img/conferences/PCV_single_cell/HCA_2025_8.jpeg'); background-size: cover; background-position: center;"></div>
    <div class="mySlides fade" style="background-image: linear-gradient(to bottom right, rgba(0, 128, 128, 0.3), rgba(0, 128, 128, 0.3)), url('../../files/img/conferences/PCV_single_cell/HCA_2025_9.jpeg'); background-size: cover; background-position: center;"></div>
    <div class="mySlides fade" style="background-image: linear-gradient(to bottom right, rgba(0, 128, 128, 0.3), rgba(0, 128, 128, 0.3)), url('../../files/img/conferences/PCV_single_cell/HCA_2025_11.jpeg'); background-size: cover; background-position: center;"></div>
    <div class="mySlides fade" style="background-image: linear-gradient(to bottom right, rgba(0, 128, 128, 0.3), rgba(0, 128, 128, 0.3)), url('../../files/img/conferences/PCV_single_cell/HCA_2025_13.jpeg'); background-size: cover; background-position: center;"></div>
  </div>
